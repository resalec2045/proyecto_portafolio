export const Card = ({ img, name, description, codeLink, demoLink }) => {
  return (
    <div className="project__card animate__animated animate__fadeIn">
      ...
      <div className="project__card--buttons">
        <a href={codeLink} className="button button-project" target="_blank">
          code
          {
            <svg
              fill="#f2f2f2"
        ...
        {demoLink !== "" && (
          <a href={demoLink} className="button button-project" target="_blank">
            Demo
            {
              <svg
                fill="#f2f2f2"
