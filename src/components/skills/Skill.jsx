            ...
            <div className="contenedor__info contenedor__info--frontend">
              <CardInformation
                {...{
                  ...
                  description:
                    "- Estudiante de Ingeniería de Sistemas en la Universidad del Quindio, 8vo semestre.",
                }}
              />
              ...
              <CardInformation
                {...{
                  ...
                  date: "2023",
                  description:
                    "- Aprendizaje de HTML 5 y CSS 3 para creación de web moderno.",
                }}
              />
              ...
              <CardInformation
                {...{
                  ...
                  date: "2022 - 2023",
                  description:
                    "- Comprensión profunda de React y su ecosistema, incluyendo Context API, autenticación con JWTs y pruebas unitarias. Desarrollé aplicaciones reales y adquirí habilidades en Redux, Hooks, MERN Stack y mucho más.",
                }}
              />
            </div>
            ...
            <div className="contenedor__info contenedor__info--backend">
              <CardInformation
                {...{
                  ...
                  date: "2023",
                  description:
                    "- Desarrollo de APIs REST y la implementación de microservicios utilizando Java y Spring Framework.  ",
                }}
              />
              ...
              <CardInformation
                {...{
                  ...
                  date: "2020",
                  description:
                    "- Formación en la creación de páginas web con bases de datos. HTML, CSS, Javascript, PHP y MySQL.",
                }}
              />
